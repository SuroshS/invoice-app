        ...
        <div className="rp-card">
          ...
          {success && (
            <div className="rp-success">
              {success}
              <br />
              <a href="/" style={{ color: "#2a7a50", fontWeight: 600, fontSize: "0.8rem" }}>
                Go to sign in →
              </a>
            </div>
          )}
          ...
          {!success && !validLink && (
            <div className="rp-invalid">
              <p style={{ marginBottom: 12 }}>⚠️ This link is invalid or has expired.</p>
              <a href="/" style={{ color: "#111", fontSize: "0.875rem" }}>← Back to sign in</a>
            </div>
          )}
          ...
          {!success && validLink && (
            <>
              ...
              <button className="rp-btn" onClick={handleReset} disabled={loading || !password || !confirm}>
