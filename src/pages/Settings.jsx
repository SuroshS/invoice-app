    ...
    <>
      ...
      <div className="sett-page">
        ...
        <div className={`sett-card card-bank ${bankOpen ? "open" : ""}`}>
          ...
          >
            <p className="sett-card-title" style={{ margin: 0 }}>
              Bank Details
            </p>
        ...
        <div className="sett-card">
          ...
          <p className="sett-card-desc">
            Your logo appears at the top of every invoice and quote.
          </p>

          <div className="sett-logo-row">
            <label className="sett-logo-btn">
              <input
                type="file"
                accept="image/*"
        ...
        <div className="sett-save-row">
          <button className="sett-save-btn" onClick={handleSave}>
            Save Settings
          </button>
