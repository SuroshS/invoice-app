...
export default function Dashboard() {
  ...
  const stats = useMemo(() => {
    ...
    const biggestJob = allInvoices.reduce(
      (max, inv) => ((inv.total || 0) > max ? inv.total || 0 : max),
      0
    );
        ...
        <div className="dash">
          <div className="welcome-wrap">
            ...
            <p>
              ...
              minutes to get set up — just add your business details and you're
              good to go.
            </p>
    ...
    <>
      ...
      <div className="dash">
        ...
        <div className="hero">
          <div className="hero-item h1">
            ...
            <div className="hero-sub">
              ...
              {stats.invoiceCount !== 1 ? "s" : ""} all time
            </div>
          </div>
        ...
        <div className="tiles">
          ...
          <div className="tile unique-clients-tile">
          ...
          <div className="tile">
            ...
            <div className="tile-value">
              {fmtShort(stats.busiestMonth?.revenue || 0)}
            </div>
              ...
              {stats.months.map((m, i) => (
                <div key={i} className="b-col">
                  ...
                  <div className="b-track">
                    <div
                      className={`b-fill${m.isCurrent ? " cur" : ""}`}
            ...
            <div className="qa-grid">
              <button className="qa-btn" onClick={() => navigate("/create")}>
                ...
                <div>
                  ...
                  <span className="qa-sub">Bill a client</span>
                </div>
              </button>
              ...
              <button className="qa-btn" onClick={() => navigate("/create")}>
                ...
                <div>
                  <span className="qa-label">New quote</span>
                  <span className="qa-sub">Send estimate</span>
                </div>
              </button>
              ...
              <button className="qa-btn" onClick={() => navigate("/invoices")}>
                ...
                <div>
                  <span className="qa-label">All records</span>
                  <span className="qa-sub">View & download</span>
                </div>
              </button>
              ...
              <button className="qa-btn" onClick={() => navigate("/settings")}>
                ...
                <div>
                  ...
                  <span className="qa-sub">Business details</span>
                </div>
              </button>
            </div>
          </div>
        ...
        <div className="grid-2-3">
          <div className="panel recent-activity-panel">
            <div className="panel-label">
              Recent activity
              <span className="panel-link" onClick={() => navigate("/invoices")}>
                view all
              </span>
            </div>
                    ...
                    <div key={i} className="client-row">
                      ...
                      <div className="c-info">
                        ...
                        <div className="c-prog">
                          <div
                            className="c-prog-fill"
                            style={{
                              width: `${(c.total / stats.maxClientTotal) * 100}%`,
                            }}
                          />
                        </div>
                      </div>
